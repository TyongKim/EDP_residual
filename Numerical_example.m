%% 
% The code predicts the standard deviation, and correlation coefficients of EDP residuals of building structures using the first and second DNN-based frameworks
